...
Nextend Twitter Connect is discontinued and [Nextend Social Login](https://wordpress.org/plugins/nextend-facebook-connect/) handles Twitter login in the future. Feel free to install and enjoy [Nextend Social Login](https://wordpress.org/plugins/nextend-facebook-connect/).
